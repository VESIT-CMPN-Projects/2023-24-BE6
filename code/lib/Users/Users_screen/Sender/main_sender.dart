...
class MainSender extends StatefulWidget {
  const MainSender({Key? key, required this.getIndex}) : super(key: key);
  final int getIndex;

  @override
  State<MainSender> createState() => _MainSenderState();
}

class _MainSenderState extends State<MainSender>
              ...
              if (userData != null) {
                ...
                switch (index) {
                  case 0:
                    ...
                    break;
                  case 1:
                    eventName = 'MyOrdersNavigation';
                    objectName = 'b_MyOrdersNavigation';
                    break;
                  case 2:
